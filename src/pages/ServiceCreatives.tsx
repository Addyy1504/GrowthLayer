...
export default function ServiceCreatives() {
  ...
  return (
    <>
      {/* 🧭 SEO META TAGS */}
      <Helmet>
        <title>Creative Services | UGC & Ad Content | GrowthLayer Studio</title>
        <meta
          name="description"
          content="We craft UGC content, ad campaigns, short-form videos, and content strategies that stop the scroll and drive conversions. Creative services that perform — not just look pretty."
        />
        <meta
          name="keywords"
          content="UGC content agency, ad creatives, short-form content, Instagram reels, TikTok videos, creative strategy, digital marketing, content studio India, GrowthLayer Studio"
        />
        <link rel="canonical" href="https://growthlayer.studio/services/creatives" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Creative Services | UGC & Ad Content | GrowthLayer Studio" />
        <meta
          property="og:description"
          content="UGC, ad creatives, reels, and data-driven content strategies engineered to convert. Partner with GrowthLayer Studio."
        />
        <meta property="og:url" content="https://growthlayer.studio/services/creatives" />
        <meta property="og:image" content="https://growthlayer.studio/og-image.png" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Creative Services | UGC & Ad Content | GrowthLayer Studio" />
        <meta
