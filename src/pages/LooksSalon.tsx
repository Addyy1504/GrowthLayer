  ...
  const sections = [
    {
      ...
      title: "Creatives",
      num: "01",
      desc: "Reels + UGC-style content that makes your salon look premium online.",
      points: ["Reels & short-form series", "UGC storytelling", "Campaign creatives"],
    },
    {
      id: "web",
      title: "Web",
      num: "02",
      desc: "A sleek website built to convert visitors into bookings.",
      points: ["Service & pricing layout", "Google reviews + SEO", "Analytics setup"],
    },
    {
      id: "labs",
      title: "Labs",
      num: "03",
      desc: "Retention automations that bring clients back—without manual follow-ups.",
      points: ["Rebooking nudges", "Feedback capture", "Client tracking dashboards"],
    },
  ];
    ...
    <div className="bg-white text-black min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <section className="bg-[#F8F9FA] pt-24 md:pt-36 pb-12 md:pb-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          >
            {/* ✅ NEW HEADING (clean + premium) */}
            <h1 className="text-[2.4rem] sm:text-5xl md:text-6xl font-black leading-[1.02] tracking-tight mb-4 md:mb-6">
              Turn Walk-ins <br className="hidden sm:block" />
              Into Regulars<span className="text-[#3EF4E4]">.</span>
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6 md:mb-8 max-w-xl mx-auto md:mx-0">
              We build a clean growth system for salons: content + website + retention,
              designed to keep chairs full.
            </p>

            {/* ✅ Better bullets (no weird spacing) */}
            <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center md:justify-start text-sm md:text-base text-gray-700 mb-7 md:mb-10">
              {["More bookings", "Premium brand feel", "Repeat clients"].map((t) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
              Simple. Clean. Built for salons that want repeat bookings.
            </p>
          </motion.div>
      ...
      >
        <h2 className="text-3xl md:text-4xl font-black mb-3">
          Want a salon system that runs itself?
        </h2>
