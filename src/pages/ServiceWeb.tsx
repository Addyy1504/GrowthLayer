...
export default function ServiceWeb() {
  ...
  return (
    <>
      {/* 🧭 SEO META TAGS */}
      <Helmet>
        <title>Web Design & Development | Custom Websites | GrowthLayer Studio</title>
        <meta
          name="description"
          content="We design and build fast, responsive, custom-coded websites with stunning design and smooth animations. No templates—just digital experiences engineered to convert."
        />
        <meta
          name="keywords"
          content="web design agency, custom website development, frontend development India, responsive websites, landing page design, conversion optimized website, GrowthLayer Studio"
        />
        <link rel="canonical" href="https://growthlayer.studio/services/web" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design & Development | GrowthLayer Studio" />
        <meta
          property="og:description"
          content="We design and build fast, responsive, custom-coded websites with stunning design and smooth animations."
        />
        <meta property="og:url" content="https://growthlayer.studio/services/web" />
        <meta property="og:image" content="https://growthlayer.studio/og-image.png" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Web Design & Development | GrowthLayer Studio" />
        <meta
