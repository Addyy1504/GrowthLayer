  ...
  const services = [
    {
      ...
      title: 'Creatives',
      description:
        'UGC, ad campaigns, reels, and content strategy that captures attention.',
    ...
    },
    {
      ...
      title: 'Web',
      description:
        'High-conversion coded websites with smooth animations and modern design.',
      path: '/services/web',
    },
    {
      icon: FlaskConical,
      title: 'Labs',
      description:
        'Automations, CRMs, WhatsApp bots, and integrations that scale.',
      path: '/services/labs',
    },
  ];
